<section class="flex items-center justify-center pb-10 dark:bg-gray-850 dark:text-white">
        ...
        <div class="isolate mx-auto grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div class="ring-1 ring-gray-200 rounded-3xl p-8 xl:p-10">
                <div class="flex items-center justify-between gap-x-4">
                    <h3 id="tier-standard" class="text-gray-900 text-2xl font-semibold leading-8 dark:text-white">Standard Package</h3>
                </div>
                <p class="mt-4 text-base leading-6 text-gray-600 dark:text-white">Ideal for individuals and small businesses</p>
            ...
            <div class="ring-2 ring-green-600 rounded-3xl p-8 xl:p-10">
                <div class="flex items-center justify-between gap-x-4">
                    <h3 id="tier-extended" class="text-green-600 text-2xl font-semibold leading-8 ">Extended Package</h3>
                    <p class="rounded-full bg-red-600/10 px-2 py-1 text-xs font-semibold text-right text-green-600">
                        HOT</p>
                </div>
                <p class="mt-4 text-base leading-6 text-gray-600 dark:text-white">Designed for growing businesses and enterprises</p>
                <p class="mt-6 flex items-baseline gap-x-1">
